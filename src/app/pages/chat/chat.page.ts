...
export class ChatPage implements OnInit {
  ...
  resize() {
    this.msgInput.nativeElement.style.height = "auto";
    this.msgInput.nativeElement.style.height =
      this.msgInput.nativeElement.scrollHeight + "px";
  }

  leave() {
    let newUsers = this.chat.users.filter(
      usr => usr.id != this.auth.currentUserId
    );
